...
Visit the **Import Users** tool:  
[`/dev/users/import`](/dev/users/import)
...
Make sure you only use this option when you're truly resetting your user list.
